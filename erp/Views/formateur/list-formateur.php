...
<head>
  <meta charset="UTF-8">
  <title>Liste des Formateurs | ErpFacil</title>
...
<body>
  <div class="content-container">
    ...
    <main>
      ...
      <?php if (!empty($allformateurs)): ?>
        <div class="table-container">
          <table class="table table-striped mt-3" id="formateurTable">
            ...
            <tbody>
              <?php foreach ($allformateurs as $allformateur): ?>
                <tr>
                  <td><?php echo $allformateur->lastname !== null ? htmlspecialchars($allformateur->lastname) : ''; ?></td>
                  <td><?php echo $allformateur->firstname !== null ? htmlspecialchars($allformateur->firstname) : ''; ?></td>
                  <?php if ($_SESSION['user']['role'] == 1): ?>
                    <td><?php echo $allformateur->nomCentre !== null ? htmlspecialchars($allformateur->nomCentre) : ''; ?></td>
                  <?php endif; ?>
                  <td>
                      <div class="action-buttons">
                        ...
                        <button class="btn btn-danger btn-sm" onclick="confirmDeleteFormateur(<?php echo $allformateur->id_users; ?>)">
      ...
      <?php include 'add-formateur.php'; ?>
     <?php include 'edit-formateur.php'; ?>
     <?php include 'delete-formateur.php'; ?>
