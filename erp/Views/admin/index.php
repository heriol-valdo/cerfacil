...
require_once __DIR__ . '/../../Controller/AdminsController.php';

$alladmins = AdminsController::ListAdmins();
...
<head>
  <meta charset="UTF-8">
  <title>Liste des Administrateurs | ErpFacil</title>
  ...
  <div class="content-container">
    ...
    <main>
      <div class="d-flex justify-content-between mt-3 mb-3">
        ...
        <div>
          <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#addStudentModal">Ajouter un administrateur</button>
        </div>
      </div>
          ...
          <table class="table table-striped mt-3" id="adminTable">
            ...
            <tbody>
              <?php foreach ($alladmins as $alladmin): ?>
                <tr>
                  <td><?php echo $alladmin->lastname !== null ? htmlspecialchars($alladmin->lastname) : ''; ?></td>
                  <td><?php echo $alladmin->firstname !== null ? htmlspecialchars($alladmin->firstname) : ''; ?></td>
                  <td><?php echo $alladmin->telephone !== null ? htmlspecialchars($alladmin->telephone) : ''; ?></td>
                  <td><?php echo $alladmin->email !== null ? htmlspecialchars($alladmin->email) : ''; ?></td>
                  <td>
                      
                      <div class="action-buttons">
                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal"
                                data-userid="<?php echo $alladmin->id_users; ?>"
                                data-email="<?php echo isset($alladmin->email) ? htmlspecialchars($alladmin->email) : ''; ?>"
                                data-firstname="<?php echo isset($alladmin->firstname) ? htmlspecialchars($alladmin->firstname) : ''; ?>"
                                data-lastname="<?php echo isset($alladmin->lastname) ? htmlspecialchars($alladmin->lastname) : ''; ?>"
                                data-telephone="<?php echo isset($alladmin->telephone) ? htmlspecialchars($alladmin->telephone) : ''; ?>"
                                data-lieutravail="<?php echo isset($alladmin->lieu_travail) ? htmlspecialchars($alladmin->lieu_travail) : ''; ?>">
                          <i class="fas fa-edit"></i>
                        </button>
                        <span class="space"></span>
                        <button class="btn btn-danger btn-sm" onclick="confirmDeleteAdmin(<?php echo $alladmin->id_users; ?>)">
      ...
      <?php else: ?>
        <p><?php echo "Aucun Administrateur"; ?></p>
      <?php endif; ?>

      <?php include 'add-admin.php'; ?>
     <?php include 'edit-admin.php'; ?>
     <?php include 'delete-admin.php'; ?>
    </main>
  ...
  <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
          ...
          function setTableHeight() {
            const totalRows = adminTable.querySelectorAll('tbody tr').length;
