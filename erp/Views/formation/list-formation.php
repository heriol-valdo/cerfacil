...
<head>
  <meta charset="UTF-8">
  <title>Liste des Formations | ErpFacil</title>
...
<body>
  <div class="content-container">
    <header>
      ...
      <div class="title"><h1>Liste des Formations</h1></div>
      </div>
    </header>
    <main>
            ...
            <tbody>
              ...
              <?php if ($_SESSION['user']['role'] == 1): ?>
                <?php foreach ($allformations as $allformation): ?>
                  <tr>
                    <td><?php echo $allformation->nom !== null ? htmlspecialchars($allformation->nom) : ''; ?></td>
                    <td><?php echo $allformation->prix !== null ? htmlspecialchars($allformation->prix). " €" : ''; ?></td>
                    <td><?php echo $allformation->lienFranceCompetence !== null ? htmlspecialchars($allformation->lienFranceCompetence) : ''; ?></td>
                    <td><?php echo $allformation->nomCentre !== null ? htmlspecialchars($allformation->nomCentre) : ''; ?></td>
                    <td>
                      
                    <div class="action-buttons">
                      <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editModal"
                              data-id="<?php echo $allformation->id; ?>"
                              data-nom="<?php echo isset($allformation->nom) ? htmlspecialchars($allformation->nom) : ''; ?>"
                              data-prix="<?php echo isset($allformation->prix) ? htmlspecialchars($allformation->prix) : ''; ?>"
                              data-lien-france-competence="<?php echo isset($allformation->lienFranceCompetence) ? htmlspecialchars($allformation->lienFranceCompetence) : ''; ?>">
                        <i class="fas fa-edit"></i>
                      </button>
                      <span class="space"></span>
                      <button class="btn btn-danger btn-sm" onclick="confirmDeleteFormation(<?php echo $allformation->id; ?>)">
     ...
     <?php include 'add-formation.php'; ?>
     <?php include 'edit-formation.php'; ?>
     <?php include 'delete-formation.php'; ?>
      ...
      <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
          ...
          function setTableHeight() {
            const totalRows = formationTable.querySelectorAll('tbody tr').length;
