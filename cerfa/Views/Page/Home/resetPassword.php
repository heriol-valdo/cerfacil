            ...
            <div class="row">
                <div class="col-md-3 center divBox btn-rounded  mediastation"  style="background: #fff;   padding: 30px; margin-top: 50px">
                    <div class="login-box">
                        ...
                        <p style="color: #00008B; margin-top: 35px;"><h1 class="text-center no-m">Mot de passe</h1></p>

                        <form class="m-t-md text-center" action="<?= App::url('ajaxresetPassword') ?>" id="resetForm">
                            
                            <div class="form-group">
                                <input type="password" class="form-control-login btn-rounded text-center" id="newPassword" placeholder="Nouveau mot de passe "  style="width: 85%;  border: 1px solid #ccc; height: 34px;   padding: 5px 12px;" required>
                            </div>

                            <div class="form-group">
                                <input type="password" class="form-control-login btn-rounded text-center" id="confirmPassword" placeholder="Confirmer votre mot de passe "  style="width: 85%;  border: 1px solid #ccc; height: 34px;   padding: 5px 12px;" required>
                                <input type="hidden" id="token" name="token" value="<?= $_GET['reset_token'] ?>" />
                            </div>
                            ...
                            <button type="submit" style="background: #153C4A;min-width:100px;" class="sendBtn btn btn-success btn-lg btn-rounded" translate="no">Récupération du compte</button>
                        </form>
