        ...
        <div>
             ...
             <div class="row">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="row">
                        <p class="mainColor text-left"><b>Représentant légal (à renseigner si l’apprenti est mineur non  émancipé) * </b> <b>*</b></p>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row"  style="margin-top:10px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" id="postalR"  name="postalR" class="form-control" placeholder="Code Postal *" required>
                                <small class="form-text text-muted">Veuillez entrer exactement 5 chiffres</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                 <input type="text" id="communeR" name="communeR" class="form-control"  placeholder="Commune *" required>
                            </div>
                        </div>
                    </div>
