...
<main class="bg-white"  > 
	<div>
        ...
        <div>
           ...
           <button type="submit" onclick="return ModalOpen();" class="sendBtn btn btn-lg btn-rounded text-center" name="submit_form" <?php if (!empty($cerfas['data']->signatureConventionEcole)) echo 'disabled'; ?>>
             Signer
            </button>
        ...
        <input type="hidden"  value="https://cerfa.heriolvaldo.com/cerfa/formEcoleConventionSignature/Public/assets/pdf/<?=$name?>" id="url">
