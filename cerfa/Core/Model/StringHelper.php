...
class StringHelper {
    ...
    public static $tabetatcerfa = [
        'TRANSMIS' => '<span class="label label-success" style="border-radius: 10px;border: 1px solid #ccc;">Statut : TRANSMIS</span>',
        'EN_COURS_INSTRUCTION' => '<span class="label label-info" style="border-radius: 5px;border: 0px solid #ccc;">Statut : EN COURS D\'INSTRUCTION</span>',
        'ENGAGE' => '<span class="label label-primary" style="border-radius: 5px;border: 0px solid #ccc;">Statut : ENGAGÉ</span>',
        'ANNULE' => '<span class="label label-danger" style="border-radius: 5px;border: 0px solid #ccc;">Statut : ANNULÉ</span>',
        'SOLDE' => '<span class="label label-default" style="border-radius: 5px;border: 0px solid #ccc;">Statut : SOLDÉ</span>',
        'REFUSE' => '<span class="label label-warning" style="border-radius: 5px;border: 0px solid #ccc;">Statut : REFUSÉ</span>',
        'NONTROUVERS' => '<span class="label label-danger" style="border-radius: 5px;border: 0px solid #ccc;">Statut : NUMÉRO INTERNE NON TROUVÉ</span>',
        '' => '<span class="label label-warning" style="border-radius: 5px;border: 0px solid #ccc;">Statut : PAS ENVOYÉ</span>',
        'RUPTURE' => '<span class="label label-danger" style="border-radius: 5px;border: 0px solid #ccc;">Statut : RUPTURE</span>'
    ];

    public static $tabetatticket = [
        'Envoyé' => '<span class="label label-success" style="border-radius: 10px;border: 1px solid #ccc;">Envoyé</span>',
        'En cours de traitement' => '<span class="label label-info" style="border-radius: 5px;border: 0px solid #ccc;">En cours de traitement</span>',
        'Résolu' => '<span class="label label-primary" style="border-radius: 5px;border: 0px solid #ccc;">Statut : Résolu</span>',
        'Abandonné' => '<span class="label label-danger" style="border-radius: 5px;border: 0px solid #ccc;">Abandonné</span>'
    ];

    public static function dateFormation($debutO,$prevuO){
        return ''. $debutO.' - '. $prevuO.'';
    }
    ...
    public static $tabState = [
        1 => '<span class="label label-success" style="border-radius: 5px;border: 0px solid #ccc;">Activé</span>',
        0 => '<span class="label label-warning" style="border-radius: 5px;border: 0px solid #ccc;">Désactivé</span>',
        2 => '<span class="label label-danger" style="border-radius: 5px;border: 0px solid #ccc;">Supprimé</span>'
    ];
