...
class App {
    ...
    private static $title = 'Cerfacil';
    private static $userss = ' | CerFacil';
    private static $naviation = 'Accueil';
    private static $breadcumb = '';
    const DB_NAME = 'u864174266_preprodcerfa';
    const DB_USER = 'u864174266_preprodcerfa';
    const DB_PASS = 'jAfHwcTUgEfs6c!';
