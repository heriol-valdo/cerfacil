...
<!-- Modale pour modifier un gestionnaire de centre -->
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Modifier un gestionnaire de centre</h5>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  editForm.addEventListener('submit', async function(e) {
    ...
    try {
      const response = await fetch("updateGestionnaireCentreFormation", {
        method: "POST",
        headers: {
      ...
      if (result.erreur) {
        ...
        setTimeout(() => {
          window.location.href = "gestionnaireCentreFormation";
        }, 3000);
      }
    } catch (error) {
